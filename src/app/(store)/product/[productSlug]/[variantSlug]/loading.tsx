...
export default function ProductVariantLoading() {
  return (
    <div className="md:max-w-[1650px] mx-auto p-4 md:p-8 overflow-x-hidden min-h-[80vh]">
      ...
      <div className="mt-10 space-y-4">
        <Skeleton className="h-8 w-32 bg-gray-200 animate-pulse" />
        <div className="space-y-4">
          {[1, 2].map((i) => (
            <div key={i} className="p-4 border rounded-lg space-y-2">
              ...
              <Skeleton className="h-16 w-full bg-gray-200 animate-pulse" />
            </div>
          ))}
        </div>
      </div>
