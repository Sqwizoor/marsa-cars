...
import { ModalData } from "@/app/providers/modal-provider"; // Import the ModalData type
...
import { deleteSubCategory, getSubCategory } from "@/queries/subCategories";
          ...
          <DropdownMenuItem
            ...
            onClick={() => {
              setOpen(
                ...
                async () => {
                  const subCategoryData = await getSubCategory(rowData?.id);
                  return {
                    rowData: subCategoryData ? { ...subCategoryData } : undefined
                  } as Partial<ModalData>;
                }
              );
            }}
          >
